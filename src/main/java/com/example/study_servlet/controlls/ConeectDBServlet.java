...
public class ConeectDBServlet extends HttpServlet {
        ...
        protected void doGet(HttpServletRequest request, HttpServletResponse response)
                ...
                try {
                        ...
                        // CarInforsDao arryList html로 출력
                        CarInforsDao carInforsDao = new CarInforsDao();
                        ArrayList carinforsDaoList = new ArrayList();
                        carinforsDaoList = carInforsDao.selectAll();
                        for (int i = 0; i < carinforsDaoList.size(); i = i + 1) {
                                HashMap hashMap = new HashMap();
                                hashMap = (HashMap) carinforsDaoList.get(i);
                                contents = contents + "<tr>\r\n " + //
